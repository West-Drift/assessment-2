...
# Define the base assets directory relative to this script
...
with tab1:
    ...
    map_path = ASSETS_DIR / "Bangweulu_Interactive_Map.html"
...
with tab2:
    ...
    def plot_ndvi_interactive(csv_filename, title):
        csv_path = ASSETS_DIR / csv_filename
    ...
    # Load data
    modis_uai_df = pd.read_csv(ASSETS_DIR / "Bangweulu_MODIS_NDVI_TimeSeries_UAIs.csv")
    modis_mcda_df = pd.read_csv(ASSETS_DIR / "Bangweulu_MODIS_NDVI_TimeSeries_MCDA_UAIs.csv")
